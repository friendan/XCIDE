...
void X_CSHA256::SetBaseData(unsigned char* pBaseDataIn)
{
	memcpy(BaseData, pBaseDataIn, 32);
}

void X_CSHA256::GetBaseData(unsigned char* pBaseDataOut)
{
	for (int i = 0; i < 8; i++)
	{
...
void X_CSHA256::SetCalcData(unsigned char* pCalcDataIn)
{
	memcpy(CalcData, pCalcDataIn, 64);
}

bool X_CSHA256::InitHash(unsigned char* pBaseData /* = NULL */)
{
...
bool X_CSHA256::CalcHash(unsigned char* pBufferIn, int BufferInSize, unsigned char* pDigestOut)
{
