...
struct editor_color_
{
	...
	BOOL       bAlignLineBtnIndent;        ///<展开收缩按钮, 释放缩进
...
// 	COLORREF   clrAlignLine;        ///<对齐线1
// 	COLORREF   clrAlignLine2;       ///<对齐线2
// 	COLORREF   clrAlignLine3;       ///<对齐线3
// 	COLORREF   clrAlignLine4;       ///<对齐线4
// 	COLORREF   clrAlignLine5;       ///<对齐线5
// 	COLORREF   clrAlignLine6;       ///<对齐线6
// 	COLORREF   clrAlignLine7;       ///<对齐线7
...
//@返回 成功返回TRUE否则返回FALSE.
//@别名 列表框_置项模板从内存()
XC_API BOOL WINAPI XListBox_SetItemTemplateXMLFromMem(HELE hEle, const void* data, int length);
...
//@备注 全局窗口图标, 所有未设置图标的窗口,都将使用此默认图标
//@参数 hImage 图标句柄
//@别名 炫彩_置窗口图标()
