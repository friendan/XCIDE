...
typedef mz_zip_reader_overwrite_cb mz_zip_reader_overwrite_cb;
typedef mz_zip_reader_password_cb mz_zip_reader_password_cb;
typedef mz_zip_reader_progress_cb mz_zip_reader_progress_cb;
typedef mz_zip_reader_entry_cb mz_zip_reader_entry_cb;
//===========================================================================
