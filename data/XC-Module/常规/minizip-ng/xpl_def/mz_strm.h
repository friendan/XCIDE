...
typedef mz_stream_open_cb mz_stream_open_cb;
typedef mz_stream_is_open_cb mz_stream_is_open_cb;
typedef mz_stream_read_cb mz_stream_read_cb;
typedef mz_stream_write_cb mz_stream_write_cb;
typedef mz_stream_tell_cb mz_stream_tell_cb;
typedef mz_stream_seek_cb mz_stream_seek_cb;
typedef mz_stream_close_cb mz_stream_close_cb;
typedef mz_stream_error_cb mz_stream_error_cb;
typedef mz_stream_create_cb mz_stream_create_cb;
typedef mz_stream_destroy_cb mz_stream_destroy_cb;
