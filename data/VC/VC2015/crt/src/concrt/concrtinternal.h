...
#define ASSERT_NOT_APP_OR_KERNELX() ASSERT(false)
#define ENSURE_NOT_APP_OR_KERNELX() throw invalid_operation()
...
#else
#define ASSERT_NOT_APP_OR_KERNELX()
#define ENSURE_NOT_APP_OR_KERNELX()
...
inline void __cdecl operator delete(void * _P, _ConcRTNewMoniker, const char *, int)
{
    ::operator delete(_P);
}
inline void * __cdecl operator new[](size_t _Size, _ConcRTNewMoniker, const char *_File, int _Line)
