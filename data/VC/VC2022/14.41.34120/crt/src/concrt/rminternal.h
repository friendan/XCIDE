...
namespace details
{
    ...
    struct SchedulerCore : public ProcessorCore
    {
        ...
        /// <summary>
        ///     Returns whether this core is idle, i.e., its subscription level was 0 at the time it was retrieved by the RM.
            ...
            for (unsigned int i = 0, j = 0; j < m_coreCount; ++i)
            {
                ...
                if (coreCount != 0 || ((affinityMask & 1) != 0))
                {
                    ...
                    if (coreCount == 0)
                        ...
                        #pragma warning(suppress: 6385) // False positive warning, VSO-1806798
